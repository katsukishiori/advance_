...
class ShopsTableSeeder extends Seeder
{
    ...
    public function run()
    {
        $shop = [
            ...
            'genre_id' => 1,
            'shop_name' => '仙人',
            'shop_overview' => '料理長厳選の食材から作る寿司を用いたコースをぜひお楽しみください。食材・味・価格、お客様の満足度を徹底的に追求したお店です。特別な日のお食事、ビジネス接待まで気軽に使用することができます。',
        ...
        $shop = [
            ...
            'genre_id' => 1,
            'shop_name' => '架空店舗',
            'shop_overview' => 'この店舗は架空の店舗です。',
            'shop_image' => 'dummy.jpg',
        ];
        DB::table('shops')->insert($shop);
    }
}
